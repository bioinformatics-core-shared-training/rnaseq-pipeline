...
An attractive feature of Galaxy is that it enables the user to chain operations together and form a workflow, which can be saved and repeated at a later date. We will exploit this shortly when performing a gene set enrichment analysis, but you can bear this in mind for your own data exploration.
...
You can find out more about these gene sets on the [msigdb](http://software.broadinstitute.org/gsea/msigdb) website. However, it is important that these gene sets have **Human gene symbols** only.
...
With this tool, three different output are produced
