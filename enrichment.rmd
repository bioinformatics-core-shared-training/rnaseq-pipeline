...
e.g. C6 oncogenic signatures which was used in the GSEA analysis of this dataset
...
In order to perform the GSEAPreRaked analysis, one needs to create file with two columns; the first containing the gene symbol, and the second is the (ranked) statistic for the gene. For those interested, here is the R code to produce a file suitable for GSEA analysis:-
