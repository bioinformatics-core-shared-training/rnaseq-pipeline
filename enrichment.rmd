...
The input we are trying to derive is a file with two-columns. The first column being a *gene symbol* and the second an ordered test statistic. As before, for those that are interested, the `dplyr` code to produce a table is given below:-
